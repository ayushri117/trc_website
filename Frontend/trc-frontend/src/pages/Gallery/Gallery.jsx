...
import { defer, useLoaderData, useActionData, Await } from "react-router-dom";
import { useState } from "react";
import "./Gallery.css";
import { AiFillCaretLeft, AiFillCaretRight } from "react-icons/ai";
import { galleryLoader } from "../Admin/Gallery/Gallery";
          ...
          <div className="Gallery_Window">
            ...
            >
              <Suspense fallback={<p style={{ color: "white" }}>Loading...</p>}>
                <Await resolve={data.galleryData}>
                  {(loadedGallery) => {
                    if (loadedGallery.length === 0) {
                      return <p style={{ color: "white" }}>No Images Here</p>;
                    }

                    for (let i of loadedGallery) {
                      images.push({
                        index: count,
                        src: i.image,
                      });
